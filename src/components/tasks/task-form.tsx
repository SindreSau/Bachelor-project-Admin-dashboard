            ...
            {isEditComponent ? (
              ...
              <>
                <Button
                  ...
                  className='bg-info/70 hover:bg-info/50 disabled:bg-info/40 inline-flex cursor-pointer items-center'
                >
                  {isDraftLoading ? (
                    <>
                      <Spinner size='xs' className='mr-2' />
                ...
                <Button
                  ...
                  disabled={isDraftLoading || isPublishLoading}
                  className='bg-confirm/80 hover:bg-confirm/70 disabled:bg-confirm/50 inline-flex cursor-pointer items-center'
                >
                  {isPublishLoading ? (
                    <>
                      <Spinner size='xs' className='mr-2' />
