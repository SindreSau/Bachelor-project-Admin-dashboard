...
>(
  (
    ...
    // Initialize with a closed state to prevent flicker
    const [_open, _setOpen] = React.useState(false);

    // Handle hydration and initial localStorage sync
    React.useEffect(() => {
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'bg-sidebar fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-100 ease-linear md:flex',
            side === 'left'
